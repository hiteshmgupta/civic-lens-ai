    ...
    <div className="min-h-screen bg-dark-950 flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-sm sm:max-w-md">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-dark-400 text-xs sm:text-sm">Create your account</p>
        </div>
        ...
        <div className="glass-card p-5 sm:p-8">
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
            ...
            <div>
              <label className="block text-xs sm:text-sm font-medium text-dark-300 mb-1.5 sm:mb-2">Username</label>
              <input
