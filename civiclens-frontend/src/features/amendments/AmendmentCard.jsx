...
export default function AmendmentCard({ amendment }) {
  const {
    ...
    createdByUsername, upvotes, downvotes, commentCount,
  ...
  return (
    <div className="glass-card-hover p-0 overflow-hidden animate-fade-in group">
      <div className="flex">
        {/* Vote Column */}
        <div className="flex-shrink-0 px-3 py-4 bg-dark-900/40 flex flex-col items-center justify-start border-r border-dark-700/30">
          <VoteControls
            amendmentId={id}
            upvotes={upvotes}
            downvotes={downvotes}
        ...
        <div className="flex-1 p-4 min-w-0">
          ...
          >
            <h3 className="text-lg font-semibold text-dark-100 mb-1.5 
          ...
          {/* Body preview */}
          <p className="text-sm text-dark-400 mb-3 line-clamp-2 leading-relaxed">
            {body}
          </p>
