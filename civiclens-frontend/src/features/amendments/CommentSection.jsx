...
function CommentItem({ comment, isAdmin, onDelete }) {
  return (
          ...
          <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 mb-1.5 sm:mb-2">
            ...
            {isAdmin && (
              <button
                ...
                className="ml-auto flex-shrink-0 p-1 sm:p-1.5 text-dark-500 hover:text-rose-400 hover:bg-rose-500/10 rounded-lg transition-colors"
