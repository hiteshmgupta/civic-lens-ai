...
class AmendmentServiceTest {
    ...
    void create_success() {
        ...
        when(voteRepository.countUpvotes(anyLong())).thenReturn(0);
        when(voteRepository.countDownvotes(anyLong())).thenReturn(0);
    ...
    void getById_success() {
        ...
        when(voteRepository.countUpvotes(10L)).thenReturn(5);
        when(voteRepository.countDownvotes(10L)).thenReturn(2);
    ...
    void update_success() {
        ...
        when(voteRepository.countUpvotes(10L)).thenReturn(0);
        when(voteRepository.countDownvotes(10L)).thenReturn(0);
